		...
		for (JsonSkin.Animation a : dst.dst) {
			...
			if(dst.draw != null) {
				skin.setDestination(obj, a.time, a.x, a.y, a.w, a.h, a.acc, a.a, a.r, a.g, a.b, dst.blend, dst.filter,
						a.angle, dst.center, dst.loop, dst.timer != null ? dst.timer.getTimerId() : 0, dst.draw != null ? dst.draw : new int[0]);
			} else {
				skin.setDestination(obj, a.time, a.x, a.y, a.w, a.h, a.acc, a.a, a.r, a.g, a.b, dst.blend, dst.filter,
						a.angle, dst.center, dst.loop, dst.timer != null ? dst.timer.getTimerId() : 0, dst.op != null ? dst.op : new int[0]);
			}
