...
*   **Progression:** Clearing the course increments the level (saved to `stepup.json`).
...
2.  **Advanced Practice:** Implement specific Time Free / Hazard features if not fully covered by existing options.
